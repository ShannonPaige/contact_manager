...
RSpec.describe PhoneNumbersController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      let(:valid_attributes) { {number: '12233445', person_id: alice.id} }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:valid_attributes) { { number: '098765', person_id: bob.id } }
      let(:new_attributes) { { number: "NewString", person_id: bob.id } }
