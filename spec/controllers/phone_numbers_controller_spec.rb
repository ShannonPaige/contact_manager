...
RSpec.describe PhoneNumbersController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      let(:valid_attributes) { {number: '12233445', contact_id: alice.id, contact_type: "Person"} }
      ...
      # xit "redirects to the created phone_number" do
      #   post :create, {:phone_number => valid_attributes}, valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:valid_attributes) { { number: '098765', contact_id: bob.id, contact_type: "Person" } }
      let(:new_attributes) { { number: "NewString", contact_id: bob.id, contact_type: "Person" } }

      it "updates the requested phone_number" do
        phone_number = PhoneNumber.create! valid_attributes
        put :update, {:id => phone_number.to_param, :phone_number => new_attributes}, valid_session
        phone_number.reload
        expect(phone_number.number).to eq('NewString')
